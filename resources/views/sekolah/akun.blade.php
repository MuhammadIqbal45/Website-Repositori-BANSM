    ...
    <div class="row">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('simpan-perubahan-akun-sekolah') }}" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <div class="row">
                ...
                <div class="card-body pt-0">
                    <div class="text-center mt-4">
                        ...
                        <div class="h6 font-weight-300">
                            <a class="btn btn-danger" href="sekolah-ganti-password"><i class="fa fa-book"></i> Perubahan Password</a>
                        </div>
