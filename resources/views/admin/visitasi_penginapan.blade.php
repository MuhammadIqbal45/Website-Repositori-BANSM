    ...
    <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                ...
                <li class="breadcrumb-item text-sm text-white active" aria-current="page">Laporan Penginapan Visitasi Admin</li>
            </ol>
            <h6 class="font-weight-bolder text-white mb-0">Laporan Penginapan Visitasi Admin</h6>
        </nav>
        ...
        <div class="col-12">
            <div class="card mb-4">
                <div class="card-header pb-0">
                    <h6>Laporan Penginapan Visitasi Admin</h6>
                </div>
                <div class="card-header d-flex">
                    <form action="admin-laporan-penginapan-visitasi" method="GET">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <th class="align-middle">
                                        <a class="btn btn-link text-danger text-gradient px-0 mb-0" href="{{ url('admin-hapus-laporan-penginapan-visitasi', $item->id)}}"><i class="far fa-trash-alt me-2" aria-hidden="true"></i>Hapus</a>
                                    </th>
                                    <th></th>
                                </tr>
                            </tbody>
