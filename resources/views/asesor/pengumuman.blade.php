    ...
    <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                ...
                <li class="breadcrumb-item text-sm text-white active" aria-current="page">Pengumuman Asesor</li>
            </ol>
            <h6 class="font-weight-bolder text-white mb-0">Pengumuman Asesor</h6>
        </nav>
        ...
        <div class="col-12">
            <div class="card mb-4">
                <div class="card-header pb-0">
                    <h6>Pengumuman Asesor</h6>
                </div>
                <div class="card-body">
                    <div class="row">
                        <form method="POST" action="{{ route('send.email.asesor') }}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <div class="row">
                ...
                <div class="card-header d-flex">
                    <h6>Log Book Pengumuman Asesor</h6>
                </div>
                <div class="card-header d-flex">
                    <form action="asesor-pengumuman" method="GET">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <th class="align-middle">
                                        <a class="btn btn-link text-danger text-gradient px-0 mb-0" href="{{ url('asesor-hapus-pengumuman', $item->id)}}"><i class="far fa-trash-alt me-2" aria-hidden="true"></i>Hapus</a>
                                    </th>
                                    <th></th>
                                </tr>
                            </tbody>
