    ...
    <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                ...
                <li class="breadcrumb-item text-sm text-white active" aria-current="page">Laporan Asesmen Asesor</li>
            </ol>
            <h6 class="font-weight-bolder text-white mb-0">Laporan Asesmen Asesor</h6>
        </nav>
        ...
        <div class="col-12">
            <div class="card mb-4">
                <div class="card-header pb-0">
                    <h6>Laporan Asesmen Asesor</h6>
                </div>
                <div class="card-body">
                    <div class="row">
                        <form method="POST" action="asesor-laporan-asesmen" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <div class="row">
                                ...
                                <div class="col-md-6 mt-3">
                                    ...
                                    <div class="custom-file" data-text="Select your file!">
                                        <input class="form-control" name="dokumen_berita_acara" placeholder="Unggah Dokumen" type="file" required oninvalid="this.setCustomValidity('Data Tidak Boleh Kosong')" oninput="setCustomValidity('')">
                                    </div>
                                </div>
                ...
                <div class="card-header d-flex">
                    <h6>Log Book Laporan Asesmen Asesor</h6>
                        ...
                        <table class="table align-items-center justify-content-center mb-0">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <th></th>
                                    <th><span class="text-xs font-weight-bold"><a href="{{ asset('dokumen/asesmen/'. $item ->dokumen_berita_acara) }}" target="_blank" rel="noopener noreferrer">Lihat Dokumen</a></span></th>
                                    <th></th>
                                    ...
                                    <th class="align-middle">
                                        <a class="btn btn-link text-danger text-gradient px-0 mb-0" href="{{ url('asesor-hapus-laporan-asesmen', $item->id)}}"><i class="far fa-trash-alt me-2" aria-hidden="true"></i>Hapus</a>
                                    </th>
                                    <th></th>
                                </tr>
                            </tbody>
                ...
                <div class="card-header pb-0">
                    <div class="tm-table-mt tm-table-actions-row">
                        <div class="box-footer">
                            {{-- <div class="box-body"> --}}
                            {!! $tambahasesmens->appends(Request::except('page'))->render() !!}
                        </div>
                    </div>
                </div>
            </div>
