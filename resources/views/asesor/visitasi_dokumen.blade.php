    ...
    <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                ...
                <li class="breadcrumb-item text-sm text-white active" aria-current="page">Laporan Visitasi Asesor</li>
            </ol>
            <h6 class="font-weight-bolder text-white mb-0">Laporan Visitasi Asesor</h6>
        </nav>
        ...
        <div class="col-12">
            <div class="card mb-4">
                <div class="card-header pb-0">
                    <h6>Laporan Dokumen Visitasi Asesor</h6>
                </div>
                <!-- <div class="card-header pb-0">
                ...
                <div class="card-body">
                    <div class="row">
                        <form method="POST" action="asesor-laporan-visitasi" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <div class="row">
                                ...
                                <div class="col-md-6 mt-3">
                                    ...
                                    <div class="custom-file" data-text="Select your file!">
                                        <input class="form-control" name="foto" placeholder="Upload Foto" type="file" required oninvalid="this.setCustomValidity('Data Tidak Boleh Kosong')" oninput="setCustomValidity('')">
                                    </div>
                                </div>
                                <div class="col-md-6 mt-3">
                                    <label>Surat Tugas</label>
                                    <div class="custom-file" data-text="Select your file!">
                                        <input class="form-control" name="surat_tugas" placeholder="Upload Dokumen" type="file" required oninvalid="this.setCustomValidity('Data Tidak Boleh Kosong')" oninput="setCustomValidity('')">
                                    </div>
                                </div>
                                <div class="col-md-6 mt-3">
                                    <label>Berita Acara</label>
                                    <div class="custom-file" data-text="Select your file!">
                                        <input class="form-control" name="berita_acara" placeholder="Upload Dokumen" type="file" required oninvalid="this.setCustomValidity('Data Tidak Boleh Kosong')" oninput="setCustomValidity('')">
                                    </div>
                                </div>
                                <div class="col-md-6 mt-3">
                                    <label>Dokumen Individu</label>
                                    <div class="custom-file" data-text="Select your file!">
                                        <input class="form-control" name="dokumen_individu" placeholder="Upload Dokumen" type="file" required oninvalid="this.setCustomValidity('Data Tidak Boleh Kosong')" oninput="setCustomValidity('')">
                                    </div>
                                </div>
                                <div class="col-md-6 mt-3">
                                    <label>Dokumen Kelompok</label>
                                    <div class="custom-file" data-text="Select your file!">
                                        <input class="form-control" name="dokumen_kelompok" placeholder="Upload Dokumen" type="file">
                                    </div>
                                </div>
                ...
                <div class="card-header d-flex">
                    <h6>Log Book Laporan Visitasi Asesor</h6>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <th class="align-middle">
                                        <a class="btn btn-link text-danger text-gradient px-0 mb-0" href="{{ url('asesor-hapus-laporan-visitasi', $item->id)}}"><i class="far fa-trash-alt me-2" aria-hidden="true"></i>Hapus</a>
                                    </th>
                                    <th></th>
                                </tr>
                            </tbody>
